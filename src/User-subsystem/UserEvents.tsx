...
const UserEvents: React.FC = () => {
  ...
  const events = [
    ...
    },
    {
      ...
      date: "2024-12-01",
      description:
        "An informative workshop on React and modern web development.",
    },
    {
      name: "Christmas Gala",
      date: "2024-12-25",
      description:
        "A formal Christmas event with music, food, and festivities.",
    },
    {
      name: "New Year Bash",
      date: "2025-01-01",
      description: "Celebrate the New Year with a grand party and fireworks.",
    },
  ];
